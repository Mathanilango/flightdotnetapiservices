...
{
    public class TicketCancelconsumer : BackgroundService
    {
        ...
        public TicketCancelconsumer(IServiceProvider sp)
        {
            _sp = sp;
            ...
            _channel.QueueDeclare(queue: "CancelTicket",
                                 durable: true,
                                 exclusive: false,
                                 autoDelete: false,
                                 arguments: null);
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(queue: "CancelTicket",
                                 autoAck: true,
                                 consumer: consumer);
